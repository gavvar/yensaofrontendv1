          ...
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            <div className="absolute right-0 top-0 h-full w-80 bg-white p-4 overflow-y-auto">
              ...
              <div className="flex gap-2">
                <button
                  onClick={resetFilters}
                  className="flex-1 py-2 bg-gray-200 rounded-md text-gray-800 text-sm font-medium"
                >
                  Xóa tất cả
                </button>
                <button
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {Array.from({ length: productsPerPage }).map((_, index) => (
                <div
                  key={index}
                  className="bg-white shadow-sm rounded-lg p-4 h-80 animate-pulse"
                >
              ...
              {viewMode === "grid" ? (
                ...
                <div className="space-y-4">
                  {products.map((product) => (
                    <div
                      key={product.id}
                      className="flex flex-col md:flex-row gap-4 bg-white shadow-sm rounded-lg overflow-hidden"
                    >
