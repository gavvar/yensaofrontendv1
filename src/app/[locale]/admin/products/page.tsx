...
export default function ProductsPage() {
  ...
  // Thêm fetchProducts vào useCallback
  ...
  }, [currentPage, limit, filter, sort, search]);
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        product.discountPrice < product.price ? (
                          <>
                            <span className="text-sm font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
                              {product.discountPrice.toLocaleString()}đ
                            </span>
                            <span className="ml-2 text-xs text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 line-through">
