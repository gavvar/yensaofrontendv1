          ...
          <div className="rounded-md bg-green-50 p-6 border border-green-100">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-6 space-y-4 w-full">
                ...
                <Link
                  href="/login"
                  className="block w-full text-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-900 dark:text-gray-100700 bg-white hover:bg-gray-50 focus:outline-none transition-colors"
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none rounded-md relative block w-full pl-10 pr-3 py-2 border border-gray-300 placeholder-gray-400 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 focus:outline-none focus:ring-amber-500 focus:border-amber-500 focus:z-10 sm:text-sm"
                  placeholder="Email"
                  value={email}
