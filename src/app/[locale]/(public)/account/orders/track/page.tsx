                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    currentIndex >= index
                      ...
                      : "bg-gray-200 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100"
                  }`}
                >
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden mb-8">
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="relative flex items-center my-8">
              ...
              <span className="flex-shrink mx-4 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 text-sm">
                HOẶC
              </span>
              <div className="flex-grow border-t border-gray-300"></div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <div className="flex flex-col sm:flex-row justify-between">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
                      Mã đơn hàng
                    </h3>
                            ...
                            <div className="relative pb-8">
                              ...
                              <div className="relative flex space-x-3">
                                ...
                                <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                  ...
                                  <div className="text-right text-sm whitespace-nowrap text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
                      Người nhận
                    </h4>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row justify-between items-center">
                  <p className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-4 sm:mb-0">
