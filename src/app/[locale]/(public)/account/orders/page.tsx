...
export default function OrdersPage() {
  ...
  }, [authLoading, isAuthenticated, router, filterParams]);
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-8">
      {/* Page header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
          Đơn hàng của tôi
        </h1>
      ...
      {loading ? (
        ...
        <div className="bg-white shadow-sm rounded-lg p-8 text-center">
          <div className="flex justify-center mb-4">
            <FiShoppingBag className="h-16 w-16 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100" />
          </div>
