...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-6">
        Thay đổi mật khẩu
      </h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-md relative block w-full pl-10 pr-10 py-2 border border-gray-300 placeholder-gray-400 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm"
