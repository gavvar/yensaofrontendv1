  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="mt-4 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link
              href="/orders"
              className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 dark:text-gray-100700 bg-white hover:bg-gray-50"
            >
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-2">
            Đặt hàng thành công!
          </h1>
          <p className="text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden mb-6">
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    order.orderStatus === "pending"
                      ? "bg-gray-100 text-gray-900 dark:text-gray-100800"
          ...
          <div className="px-6 py-4">
            <h3 className="font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-3">
              Tóm tắt đơn hàng
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white shadow-sm rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b">
              <h3 className="font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 flex items-center">
            ...
            <div className="px-6 py-4">
              ...
              <p className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mt-2">
                {order.customerEmail}
              </p>
              <p className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mt-2">
              ...
              {order.note && (
                <div className="mt-3 pt-3 border-t border-gray-100">
                  <p className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 italic">
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden mb-8">
          ...
          <div className="divide-y">
            {(order.items || []).length > 0 ? (
              ...
              <div className="px-6 py-4 text-center text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <Link
            href="/products"
            className="w-full sm:w-auto flex items-center justify-center px-6 py-3 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-900 dark:text-gray-100700 bg-white hover:bg-gray-50"
          >
