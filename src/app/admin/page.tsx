    ...
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-gray-900">Chào mừng trở lại, Admin!</p>
        </div>
        ...
        <div className="flex items-center space-x-4 mt-4 md:mt-0">
          ...
          <button className="bg-white border border-gray-300 rounded-md p-2 hover:bg-gray-50">
            <FiFilter className="h-5 w-5 text-gray-900" />
          </button>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-900">Phân bố theo trạng thái</p>
            </div>
