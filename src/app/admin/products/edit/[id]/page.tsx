    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => router.back()}
            className="px-4 py-2 border border-gray-300 rounded-md text-gray-900 dark:text-gray-100700 hover:bg-gray-50"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100700 border-b pb-2">
                Thông tin cơ bản
              </h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute left-3 top-2 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
                    đ
                  </span>
                </div>
                {errors.price && (
          ...
          {/* Hình ảnh sản phẩm */}
          <div className="mt-8">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100700 border-b pb-2 mb-4">
              Hình ảnh sản phẩm
            </h2>
            ...
            <div className="mb-4">
              ...
              <span className="ml-3 text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
            ...
            {formData.images && formData.images.length > 0 && (
              <>
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100700 mb-2">
                  Ảnh hiện tại
                </h3>
                        ...
                        <button
                          ...
                          className={`px-2 py-1 text-xs rounded ${
                            img.isFeatured
                              ...
                              : "bg-gray-100 text-gray-900 dark:text-gray-100800 hover:bg-gray-200"
                          }`}
                        >
