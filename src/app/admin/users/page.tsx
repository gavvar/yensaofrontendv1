...
export default function AdminUsers() {
  ...
  // Thêm fetchUsers vào useCallback
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        <div className="flex items-center space-x-3 mt-4 md:mt-0">
          ...
          <div className="relative">
            ...
            <FiFilter className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 pointer-events-none" />
          </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {users.length > 0 ? (
                    ...
                    <tr className="text-center">
                      <td
                        colSpan={6}
                        className="px-6 py-10 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100"
                      >
                        ...
                        <button
                          ...
                          className={`relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium ${
                            currentPage === pageNum
                              ...
                              : "bg-white text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 hover:bg-gray-50"
                          }`}
                        >
                          {pageNum}
                        </button>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
                  {selectedUser?.id
                ...
                <button
                  ...
                  className="text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 hover:text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100"
                >
              ...
              <form onSubmit={handleSaveUser}>
                <div className="space-y-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-gray-900 dark:text-gray-100700"
                    >
                      Họ tên
                    </label>
                    <input
                ...
                <div className="mt-6 flex justify-end space-x-3">
                  <button
                    type="button"
                    onClick={handleCloseModal}
                    className="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 dark:text-gray-100700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
                  >
                    Huỷ
                  </button>
                  <button
