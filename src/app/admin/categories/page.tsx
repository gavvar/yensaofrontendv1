...
export default function CategoriesPage() {
  ...
  // Thêm fetchCategories vào useCallback
  ...
  const getBreadcrumb = (category: Category) => {
    ...
    return (
      <span className="text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 text-xs flex items-center">
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div className="flex items-center mb-2">
          ...
          <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100700">
            Bộ lọc
          </h2>
        </div>
            ...
            <div className="flex space-x-4">
              <button
                ...
                className={`px-3 py-1 rounded-md text-sm ${
                  filterActive === true
                    ...
                    : "bg-gray-100 text-gray-900 dark:text-gray-100700 border border-gray-200"
                }`}
              >
                Hoạt động
              </button>
              ...
              {filterActive !== null && (
                <button
                  ...
                  className="px-2 py-1 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 hover:text-gray-900 dark:text-gray-100700"
                >
                  <FiX size={16} />
                </button>
              )}
            ...
            <div className="flex">
              ...
              {filterParent !== null && (
                <button
                  ...
                  className="px-2 py-1 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 hover:text-gray-900 dark:text-gray-100700 ml-2"
                >
                  <FiX size={16} />
                </button>
              )}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {categories.map((category) => (
                <tr key={category.id}>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        {category.description && (
                          <p className="text-xs text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mt-1 truncate max-w-xs">
                            {category.description}
                          </p>
                        )}
                      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 font-mono">
                      {category.slug}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
