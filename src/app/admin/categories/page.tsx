...
// Loại bỏ import router nếu không sử dụng
...
export default function CategoriesPage() {
  // Loại bỏ biến router vì không sử dụng
  ...
  // Sửa kiểu dữ liệu cho error, thay vì any sử dụng unknown rồi type check
            ...
            <div className="flex">
              ...
              {filterParent !== undefined && (
                <button
                  ...
                  className="px-2 py-1 text-gray-500 hover:text-gray-700 ml-2"
                >
                  <FiX size={16} />
                </button>
              )}
                      ...
                      {category.imageUrl && !imageErrors[category.id] ? (
                        <div className="flex-shrink-0 h-10 w-10 mr-3 relative">
                          <Image
                            ...
                            sizes="40px"
                            onError={() => {
                              // Sử dụng state để xử lý ảnh lỗi
                              setImageErrors((prev) => ({
                                ...prev,
                                [category.id]: true,
                              }));
                        ...
                        // Hiển thị placeholder khi không có ảnh hoặc ảnh bị lỗi
