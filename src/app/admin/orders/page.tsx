      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        <div className="flex items-center space-x-3 mt-4 md:mt-0">
          <div className="relative">
            ...
            />
            <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100" />
          </div>

          <button
            className="bg-white border border-gray-300 rounded-md p-2 hover:bg-gray-50 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100"
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6 p-4 border border-gray-200">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center">
              ...
              <label
                htmlFor="selectAll"
                className="ml-2 text-gray-900 dark:text-gray-100700"
              >
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`flex items-center px-4 py-2 rounded ${
                  selectedIds.length === 0
                    ? "bg-gray-100 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 cursor-not-allowed"
              ...
              <button
                onClick={refresh}
                className="flex items-center px-4 py-2 rounded bg-gray-100 text-gray-900 dark:text-gray-100700 hover:bg-gray-200"
              >
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="px-6 py-3 text-left text-xs font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 uppercase tracking-wider cursor-pointer"
                      onClick={() =>
                        changeSort(
                          "orderNumber",
                    ...
                    <th
                      scope="col"
                      className="px-6 py-3 text-right text-xs font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 uppercase tracking-wider cursor-pointer"
                      onClick={() =>
                        changeSort(
                          "totalAmount",
                          filters.sortOrder === "asc" ? "desc" : "asc"
                    ...
                    <th
                      scope="col"
                      className="px-6 py-3 text-center text-xs font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 uppercase tracking-wider cursor-pointer"
                      onClick={() =>
                        changeSort(
                          "orderStatus",
                          filters.sortOrder === "asc" ? "desc" : "asc"
                    ...
                    <th
                      scope="col"
                      className="px-6 py-3 text-center text-xs font-medium text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 uppercase tracking-wider"
                    >
                      Thanh toán
                    </th>
                    <th
                  ...
                  {orders.length > 0 ? (
                    ...
                    <tr>
                      <td
                        ...
                        className="px-6 py-10 text-center text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100"
                      >
                    ...
                    >
                      <button
                        ...
                        className={`relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium ${
                          pagination.page <= 1
                            ? "text-gray-900 dark:text-gray-100300 cursor-not-allowed"
                            : "text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 hover:bg-gray-50"
                        }`}
                      >
                        ...
                        <button
                          ...
                          className={`relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium ${
                            pagination.page === pageNumber
                              ...
                              : "text-gray-900 dark:text-gray-100700 hover:bg-gray-50"
                          }`}
                        >
                          {pageNumber}
                        </button>
      ...
      {confirmModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-4">
              {actionType === "delete"
            ...
            <div className="flex justify-end space-x-3">
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded-md text-gray-900 dark:text-gray-100700 bg-white hover:bg-gray-50"
              >
                Hủy
              </button>
              <button
