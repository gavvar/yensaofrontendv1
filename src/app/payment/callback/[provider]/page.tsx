      ...
      <div className="bg-white rounded-lg shadow-sm p-8 text-center">
        {status === "loading" && (
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-900">Vui lòng đợi trong giây lát...</p>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              ...
              <Link
                href="/"
                className="flex items-center justify-center border border-gray-300 text-gray-700 px-6 py-2.5 rounded-md hover:bg-gray-50 transition-colors"
              >
