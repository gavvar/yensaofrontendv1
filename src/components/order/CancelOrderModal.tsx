  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <p className="mb-4 text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100">
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-900 dark:text-gray-100900 dark:text-gray-900 dark:text-gray-100100 mb-2">
          ...
          <div className="flex flex-wrap gap-2">
            {commonReasons.map((reason) => (
              <button
                ...
                className="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-900 dark:text-gray-100700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
              >
                {reason}
              </button>
            ))}
        ...
        <div className="mt-6 flex justify-end space-x-3">
          <button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="inline-flex justify-center px-4 py-2 text-sm font-medium text-gray-900 dark:text-gray-100700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
          >
            Quay lại
          </button>
          <button
